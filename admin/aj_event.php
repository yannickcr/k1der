...
$date = date("d/m/Y");
?>
<form name="the_form" method="post" action="admin/aj_event2.php" onSubmit="return isOK()">
  <table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr> 
      <td height="2"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Titre 
        : </font></td>
      <td height="2"><input name="titre" type="text" id="titre" value="Ev&egrave;nement"></td>
    </tr>
    <tr> 
