...
$gg2 = $gg-1;
$requete  = "INSERT INTO dossiers VALUES('','$auteur','$date','$titre','$image','$resume','$Text','$titrepage','$gg2','')";
$req = mysql_query($requete) or die('Erreur SQL !<br>'.$requete.'<br>'.mysql_error());

$req = MYSQL_QUERY("SELECT * FROM dossiers ORDER BY id DESC LIMIT 0,1");
$disp = mysql_fetch_array($req);

$id_dossier2 = $disp[id];

mysql_query("UPDATE dossiers SET id_dossier='$id_dossier' WHERE id_dossier=''");
...
mysql_query("UPDATE dossiers SET id_dossier='$id_dossier' WHERE id='$id_dossier'");
}
...
<BODY onfocus="TraitEvent()" BGCOLOR=White TEXT=Black LINK=Blue VLINK=Blue ALINK=Blue LEFTMARGIN=0 TOPMARGIN=4 MARGINWIDTH=0 MARGINHEIGHT=4>
   <div align="center"><FORM METHOD="POST" action="index.php?page=aj_dossier" name="webmail" onsubmit="return true;">
    <TABLE width="570" 
        border=0 cellPadding=3 cellSpacing=0 class=forumline>
      <TBODY>
        <TR> 
          <TD colspan="2" class=row1><div align="center"><strong><font size="4" face="Verdana, Arial, Helvetica, sans-serif">Ecrire 
              un Dossier</font></strong></div></TD>
        </TR>
        <TR> 
        ...
        <TR> 
          ...
          <TD width="612" class=row2><SPAN class=genmed> <font size="2" face="Verdana, Arial, Helvetica, sans-serif">
			...
			echo $auteur;
			?>
            <input name="auteur" type="hidden" id="auteur" value="<? echo $auteur; ?>"><input name="gg" type="hidden" id="gg" value="<? echo $gg; ?>">
			<input name="id_dossier" type="hidden" id="id_dossier" value="<? echo $id_dossier; ?>">
            </font></SPAN></TD>
        </TR>
		<?
		if ($submit == "")
		...
		?>
        <TR> 
          <TD width="125" nowrap class=row1><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><SPAN class=gen>Titre 
            du Dossier :</SPAN></font></TD>
          <TD class=row2><SPAN class=gen> 
            <INPUT class=post 
            style="WIDTH: 350px" tabIndex=2size=45 name=titre>
            </SPAN></TD>
        </TR>
		<?
		}
        ...
        <TR> 
          <TD valign="top" nowrap class=row1><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Titre 
            de la Page :</font></TD>
          <TD class=row2><INPUT class=post 
            style="WIDTH: 350px" tabIndex=2size=45 name=titrepage>
        <?
		if ($submit == "")
		{
		?>
			<br>
            <font size="1" face="Verdana, Arial, Helvetica, sans-serif">(inutile 
            si page unique)</font>
			<?
			}
			?></TD>
		...
		?>	
        <TR> 
          <TD width="125" valign="top" class=row1><font size="2" face="Verdana, Arial, Helvetica, sans-serif">R&eacute;sum&eacute; 
            :</font></TD>
          <TD class=row2><SPAN class=gen> 
            <textarea name="resume" rows="4" style="WIDTH: 350px" wrap="HARD"></textarea>
            </SPAN></TD>
        </TR>
        <TR> 
          <TD width="125" class=row1><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Image 
            :</font></TD>
          <TD class=row2><span class=gen> 
            <input name=image class=post 
            style="WIDTH: 325px" tabindex=2 value="http://" size=45>
            <font size="1" face="Verdana, Arial, Helvetica, sans-serif"><br>
            (Max 160x120 de pr&eacute;f&eacute;rence)</font></span></TD>
        </TR>
		<?
		}
		?>
              ...
              <td><table width="570" border="0" cellspacing="0" cellpadding="10" bgcolor="FFFFFF">
                  ...
                  <tr> 
                    <td><div id='boite' name='boite' style='height: 700; position: relative; top: 0px; width: 100%; border: 1px solid #000000'> 
                        <textarea wrap="HARD" name="Text2" id="textarea4" rows=1 style='left : 0px; top : 0px ;HEIGHT: 100%; visibility: visible; POSITION: absolute ; WIDTH: 100%; Z-INDEX: 100' cols='20'></Textarea>
                  ...
                  <tr> 
                    <td width='110' height="58"> <input name='Val' type='hidden'> 
                      ...
                      <span class="gen"> 
                      <input name="Subject" type="hidden" id="Subject5" value="d">
                      </span></td>
                  </tr>
                  <script language="javascript">
              setTimeout('LancerEditeur()',200);</script>
                </table></td>
            </tr></table><tr><td></table><input type="submit" name="submit" value="Terminer" onClick="javascript:texttoobig('Act_C_Send', 1, 1)">
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    <input type="submit" name="submit" value="Nouvelle Page" onClick="javascript:texttoobig('Act_C_Send', 1, 1)">
    &nbsp; <br>
  </form>
  </div>
</BODY>
