...
if ($type != "admin")
{
$requete3  = "INSERT INTO ib_topics VALUES ('', '$titre', '', 'open','0', '$disp5[id]','$date666', '0','$date666', 0, '$auteur', '$auteur','0','0','0','1','1','0','_$disp6[id]_', '', '','0','0','0','0');";
...
$requete2  = "INSERT INTO ib_posts VALUES('0','','','$disp5[id]','$auteur','0','1','127.0.0.1','$date666','','$Text','0','$disp[tid]','1','','_$disp6[id]_','','','')";
...
{
$requete3  = "INSERT INTO ib_topics VALUES ('', '$titre', '', 'open','0', '$disp5[id]','$date666', '0','$date666', 0, '$auteur', '$auteur','0','0','0','26','1','0','_$disp6[id]_', '', '','0','0','0','0');";
$req3 = mysql_query($requete3) or die('Erreur SQL !<br>'.$requete3.'<br>'.mysql_error());
$req = MYSQL_QUERY("SELECT * FROM ib_topics ORDER BY tid DESC LIMIT 0, 1");
$disp = mysql_fetch_array($req);

$requete2  = "INSERT INTO ib_posts VALUES('0','','','$disp5[id]','$auteur','0','1','127.0.0.1','$date666','','$Text','0','$disp[tid]','26','','_$disp6[id]_','','','','1','')";

//$req = mysql_query($requete) or die('Erreur SQL !<br>'.$requete.'<br>'.mysql_error());
$req2 = mysql_query($requete2) or die('Erreur SQL !<br>'.$requete2.'<br>'.mysql_error());

$req = MYSQL_QUERY("SELECT * FROM ib_forums WHERE id='26'");
$disp = mysql_fetch_array($req);
$topics = $disp[topics]+1;
