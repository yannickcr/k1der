...
$ladate = date2timestamp("$annee$mois$jour$heure$minute","YmdHi");
...
$ladate = addslashes($ladate);
$heure = addslashes($mechants);
$heure = addslashes($heure);
$minute = addslashes($minute);
$occ = addslashes($occ);
$joueur1 = addslashes($joueur1);
$joueur2 = addslashes($joueur2);
$joueur3 = addslashes($joueur3);
$joueur4 = addslashes($joueur4);
$joueur5 = addslashes($joueur5);
$map = addslashes($map2);
$annee = addslashes($annee);
$mois = addslashes($mois);
$jour = addslashes($jour);

$requete  = "INSERT INTO next_matches (id,mechants,mail,server,date,heure,occ,joueur1,joueur2,joueur3,joueur4,joueur5,map,map2,orderdate) VALUES('','$mechants','$mail','$server','$ladate','$heure:$minute','$occ','$joueur1','$joueur2','$joueur3','$joueur4','$joueur5','$map','$map2','$annee$mois$jour')";
$req = mysql_query($requete) or die('Erreur SQL !<br>'.$requete.'<br>'.mysql_error());
?>
<script language="Javascript">
alert('Prochain Matche ajouté avec succès');
