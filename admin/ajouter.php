      ...
      <TBODY>
        <TR> 
          <TD colspan="3" class=row1><table width="600" border="0" cellspacing="0" cellpadding="0" align="left">
              ...
              <tr> 
                <td width="439" height="20" background="images/fond.gif"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><img src="images/courbe1.gif" width="7" height="20" align="absmiddle"><b><font color="#FFFFFF">-=</font></b></font><font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>Insertion 
                  d'une News</b></font><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b><font color="#FFFFFF">=-</font></b></font></td>
              </tr>
              <tr> 
                <td colspan="2">&nbsp;</td>
              </tr>
        ...
        <TR> 
          ...
          <TD width="306" class=row2><SPAN class=genmed> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
            ...
            <input name="heure" type="hidden" id="heure" value="<? echo $heure; ?>">
            </font></SPAN></TD>
