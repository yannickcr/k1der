...
<BODY onfocus="TraitEvent()" BGCOLOR=White TEXT=Black LINK=Blue VLINK=Blue ALINK=Blue LEFTMARGIN=0 TOPMARGIN=4 MARGINWIDTH=0 MARGINHEIGHT=4>
   <div align="center">
  <FORM METHOD="POST" action="admin/ajouter2.php" name="webmail" onsubmit="return true;">
    <TABLE width="600" 
      ...
      <tr> <td width="439" height="20" background="images/fond.gif"><font face="Verdana, Arial, Helvetica, sans-serif" size="2"><img src="images/courbe1.gif" width="7" height="20" align="absmiddle"><b><font color="#FFFFFF">-=</font></b></font><font color="#FFFFFF" face="Verdana, Arial, Helvetica, sans-serif" size="2"><b>Insertion 
      d'une News</b></font><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b><font color="#FFFFFF">=-</font></b></font></td></tr> 
      <tr> <td colspan="2">&nbsp;</td></tr> </table></TD>
        ...
        <TR> 
          ...
          <TD width="306" class=row2><SPAN class=genmed> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
			...
			echo $auteur;
			?>
            <input name="auteur" type="hidden" id="auteur" value="<? echo $auteur; ?>"><input name="date" type="hidden" id="date" value="<? echo $date; ?>"><input name="heure" type="hidden" id="heure" value="<? echo $heure; ?>">
            </font></SPAN></TD>
          <TD width="306" class=row2><span class=genmed><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Date 
            :</strong> <? echo $date; ?> <strong>&amp;</strong> <strong>Heure 
            :</strong> <? echo $heure; ?> </font></span></TD>
        </TR>
        <TR> 
          ...
          <TD colspan="2" class=row2><SPAN class=gen> 
            <INPUT class=post 
            style="WIDTH: 450px" tabIndex=2size=45 name=titre>
            </SPAN></TD>
        </TR>
        <TR> 
        ...
        <table width="600" border="0" cellspacing="0" cellpadding="0">
            <tr> 
              <td><table width="600" border="0" cellspacing="0" cellpadding="10" bgcolor="FFFFFF">
                    ...
                    <td width="100%"> <div id='BoiteOutils' style='width: 100%; position: relative; top: 0px; visibility:hidden'> 
                        <table height='28' border='0' cellpadding='0' cellspacing='0' width="100%" onMouseover="over_effect(event,'outset')" onMouseout="over_effect(event,'solid')" onMousedown="over_effect(event,'inset')" onMouseup="over_effect(event,'outset')" style="background-color:#Ffffff">
                          <tr> 
                            ...
                            <td> 
                            <td class="menulines" onClick="StyleCar('strikethrough')"><img src='images/strike.gif'border="0" alt="Barré"> 
                            <td> 
                  ...
                  <tr> 
                    <td><div id='boite' name='boite' style='height: 310; position: relative; top: 0px; width: 100%; border: 1px solid #000000'> 
                        <textarea wrap="HARD" name="Text2" id="textarea5" rows=1 style='left : 0px; top : 0px ;HEIGHT: 100%; visibility: visible; POSITION: absolute ; WIDTH: 100%; Z-INDEX: 100' cols='20'></Textarea>
