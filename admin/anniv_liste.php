...
$req = MYSQL_QUERY("SELECT * FROM anniv ORDER BY id DESC");
...
function Supprimer(data)
{
 ...
 if(resultat==1)
 {
  window.location='admin/suppr_anniv.php?id='+data;
 }
 else
 {
...
?>
		...
		if ($action == 'modif')
		{
		echo "<b><a class=type1 href=\"index.php?page=modif_anniv&id=$disp[id]\">Modifier</a></b>";
		}
		else
		{
