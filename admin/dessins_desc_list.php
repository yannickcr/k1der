...
?>
      <td width="50%"> <div align="center"> 
          <table border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
            <tr> 
              <td bordercolor="#000000"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><img src="images/dessins/<? echo $fichier; ?>/piti/<? echo $fichier2; ?>"></font></td>
            </tr>
          </table>
          <font size="2" face="Verdana, Arial, Helvetica, sans-serif"> </font> 
          <form name="form1" method="post" action="admin/modif_dessins_desc.php">
            <input name="image" type="hidden" id="image" value="<? echo $image_desc; ?>">
            <input name="fichier" type="hidden" id="fichier" value="<? echo $fichier; ?>">
            <input name="desc" type="text" id="desc" value="<? echo $desc; ?>" size="50">
            <br>
