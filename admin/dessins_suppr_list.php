...
?>
      <td width="50%"> <div align="center"> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
          ...
          <form name="form1" method="post" action="admin/suppr_dessins.php">
            <br>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td><div align="center">
                    ...
                    <input name="image" type="hidden" id="image2" value="<? echo $image_desc; ?>">
                    <input name="fichier" type="hidden" id="fichier2" value="<? echo $fichier; ?>">
                  </div></td>
                <td><div align="center">
