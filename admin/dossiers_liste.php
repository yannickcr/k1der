...
$req = MYSQL_QUERY("SELECT * FROM dossiers WHERE page='1' ORDER BY id DESC");
...
{
 resultat = confirm('Attention ! Vous allez supprimer le dossier '+data2+' ');
 if(resultat==1)
 {
  window.location='admin/suppr_dossier.php?id='+data+'&nom='+data2;
 }
 else
 {
            ...
            <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr> 
                <td width="439" height="20" background="images/fond.gif"><img src="images/courbe1.gif" width="7" height="20" align="absmiddle"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b><font color="#FFFFFF">-= 
                  <? if ($action == "modif") { echo "Modifier"; } else { echo "Supprimer"; } ?>
...
?>
            <tr> 
              <td class="m9" width="460"> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b><? echo $disp[titre]; ?></b></font></td>
              <td align="center" class="m9"> 
                <?
		if ($action == 'modif')
		{
		echo "<b><a class=type1 href=\"index.php?page=modif_dossier&dossier_edit=$disp[id]\">Modifier</a></b>";
		}
		else
		{
