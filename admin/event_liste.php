...
$req = MYSQL_QUERY("SELECT * FROM events ORDER BY id DESC");
...
{
 resultat = confirm('Voulez-vous vraiment supprimer l\'évènement ?');
 if(resultat==1)
 {
  window.location='admin/suppr_event.php?id='+data;
 }
 else
 {
  ...
  <center>
    ...
    <table width="500" border="0" cellspacing="0" cellpadding="0">
      <tr> 
		...
		?>
                  un &eacute;venement=-</font></b></font></td>
              </tr>
              <tr> 
                <td colspan="2">&nbsp;</td>
              </tr>
...
?>
            <tr> 
              <td class="m9" width="460"> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><? echo $disp[text]; ?> 
                </font></td>
              <td align="center" class="m9"> 
                <?
		if ($action == 'modif')
		{
		echo "<b><a class=type1 href=\"index.php?page=modif_event&id=$disp[id]\">Modifier</a></b>";
		}
		else
		{
		$nom = str_replace("'","\'",$disp[nom]);
		echo "<b><a class=type1 href=\"Javascript:Supprimer('$disp[id]');\">Supprimer</a></b>";
		}
		?>
              </td>
            </tr>
