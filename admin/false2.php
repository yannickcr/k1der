...
mysql_query("UPDATE equipe SET statut='non' WHERE kinder='$HTTP_COOKIE_VARS[gen]'");
...
$joueur = str_replace($joueur,"",$disp[joueurs]);
...
alert("Tu as été supprimé de la liste des joueurs qui viennent à la LAN");
