...
$req = MYSQL_QUERY("SELECT * FROM calendrier ORDER BY id DESC");
...
{
 resultat = confirm('Attention ! Vous allez supprimer la LAN '+data2+' et tous les fichiers/photos associés.\n\n                                 Voulez-vous vraiment continuer ?');
 if(resultat==1)
 {
  window.location='admin/suppr_lan.php?id='+data+'&nom='+data2;
 }
 else
 {
...
?>
            <tr> 
              <td class="m9" width="460"> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b><? echo $disp[nom]; ?></b></font></td>
              <td align="center" class="m9"> 
                <?
		if ($action == 'modif')
		{
		echo "<b><a class=type1 href=\"index.php?page=modif_lan&id=$disp[id]\">Modifier</a></b>";
		}
		else
		{
