<?
include "secu.php";?><STYLE type=text/css>A {
...
if(strlen($titre)>=13){ $titre = substr($titre,0,7)."..."; }

?>
                <tr>
                  <td nowrap> <font style="<? echo $Headline; ?>"> 
                    <? echo $date; ?>
                    &nbsp;<img src="../images/fle_ble.gif" border="0"><a href="<? echo $PATH_INDEX; ?>#id_news_<? echo $id; ?>"> 
                    <? echo $titre; ?>
                    </a></font> </td>
                </tr>
                <?
