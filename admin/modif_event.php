...
$req = MYSQL_QUERY("SELECT * FROM events WHERE id='$id'");
  ...
  <table width="500" border="0" cellspacing="0" cellpadding="0">
          ...
          <table width="465" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr> 
              <td width="439" height="20" background="images/fond.gif"><img src="images/courbe1.gif" width="7" height="20" align="absmiddle"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><b><font color="#FFFFFF">-=Modification 
                de l'&eacute;venement=-</font></b></font></td>
            </tr>
            <tr> 
              <td colspan="2">&nbsp;</td>
            </tr>
    ...
    <tr> 
      <td width="475"> <table border="0" cellpadding="4" cellspacing="0" width="490">
          <tr> 
            <td nowrap> <form method="POST" action="admin/modif_event2.php">
                <p> 
                  <input type="hidden" value="<? echo $disp[id]; ?>" name="id">
                </p>
                <table width="500" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr> 
                    <td height="2"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Titre 
                      :</font></td>
					  <?
					  if ($disp[titre] == '') { $disp[titre] = "Evènement"; }
					  ?>
                    <td height="2"><input name="titre" type="text" id="titre" value="<? echo $disp[titre]; ?>" size="30"></td>
                  </tr>
                  <tr> 
                    <td height="2" width="250"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Texte 
                      : </font></td>
                    <td height="2" width="250"> <input name="text" type="text" id="text" value="<? echo $disp[text]; ?>" size="30"></td>
                  </tr>
                  <tr> 
                    <td height="24" width="250"><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Date 
                      : 
                      <?
					  $ladate = date2timestamp("$disp[date]","Ymd");
					  
					  $disp[jour] = date("d",$ladate);
					  $disp[mois] = date("m",$ladate);
					  $disp[annee] = date("Y",$ladate);
					  ?>
                      </font></td>
