...
$rqt = Mysql_Query("UPDATE next_matches SET mechants='$mechants', date='$ladate', heure='$heure:$minute', occ='$occ', joueur1='$joueur1', joueur2='$joueur2', joueur3='$joueur3', joueur4='$joueur4', joueur5='$joueur5', map='$map', map2='$map2', orderdate='$annee$mois$jour' WHERE id='$id'");

if(!$rqt)
{
 $ALERT = "Une erreur s\'est produite, le prochain matche n\'a pas été mis à jour !";
}
else
{
 $ALERT = "Le prochain matche a été mis à jour avec succès !";
}
