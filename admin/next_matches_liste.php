...
$req = MYSQL_QUERY("SELECT * FROM next_matches ORDER BY date DESC");
...
function Supprimer(data,data2)
{
 ...
 if(resultat==1)
 {
  window.location='admin/suppr_next_matche.php?id='+data;
 }
 else
 {
...
?>
		...
		if ($action == 'modif')
		{
		echo "<b><a class=type1 href=\"index.php?page=modif_next_matche&id=$disp[id]\">Modifier</a></b>";
		}
		else
		{
