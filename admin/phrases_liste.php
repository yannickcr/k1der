...
function Modifier(data)
	{
	window.open("admin/modif_phrase.php?phrase="+data,"Modifier","toolbar=0,location=0,directories=0,menuBar=0,scrollbars=0,resizable=0,height=300,width=500")
...
{
 resultat = confirm('Voulez-vous vraiment supprimer cette la phrase à la con ?');
 if(resultat==1)
 {
  window.location='admin/suppr_phrases.php?phrase='+data;
 }
 else
 {
...
?>
            <tr> 
              <td class="m9" width="460"> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"><? echo $disp[phrase]; ?> 
                </font></td>
              <td align="center" class="m9"> 
                <?
				$phrase = str_replace("'", "\'", $disp[phrase]);
		if ($action == 'modif')
		{
		echo "<b><a class=type1 href=\"Javascript:Modifier('$phrase');\">Modifier</a></b>";
		}
		else
		{
		echo "<b><a class=type1 href=\"Javascript:Supprimer('$phrase');\">Supprimer</a></b>";
		}
		?>
              </td>
            </tr>
