...
?>
<form action="ajouter_comm_down2.php" method="POST" name="comment" id="comment" onSubmit="return part()">
  <input name="id_down" type="hidden" id="id_down" value="<? echo $id; ?>">
  <div align="center">
  <center>
                        ...
                        <tr> 
                          <td width="41%" align="center"> 
                            <div align="right"><font style="<? echo $CorpsNews; ?>">Note 
                              donn&eacute;e &agrave; ce fichier :</font><font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
                              </font></div></td>
                          <td align="center">
