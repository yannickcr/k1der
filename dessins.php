...
<body>
<div align="center"><font face="Verdana" size="4" color="#987898"><img src="images/k1der2.gif" align="middle"></font><br>
  <br>
<?
...
if(!is_array($listing)) 
	...
	echo "dessins.php?rep=totoimages</font>\n";
	}
else
	{
	...
	if($precedent!="")
		{
		$tableau.="<a href=\"dessins.php?rep=$rep&image=$debut\"><img STYLE='filter:fliph' src='images/fleche.jpg' border=0 align='absmiddle'><img STYLE='filter:fliph' src='images/fleche.jpg' border=0 align='absmiddle'></a>&nbsp;&nbsp;&nbsp;\n";
		$tableau.="<a href=\"dessins.php?rep=$rep&image=$precedent\"><img STYLE='filter:fliph' src='images/fleche.jpg' border=0 align='absmiddle'></a>\n";
		}
	$tableau.="</font></td><td align=\"center\"><font face=\"Verdana\" size=\"2\">Dessin <b>$numphoto</b> sur <b>$i</b></font></td>
	<td align=\"right\" width=\"10%\"><font face=\"Verdana\" size=\"2\">";
	// Liens suivant et fin
	if($suivant!="")
		{
		$tableau.="<a href=\"dessins.php?rep=$rep&image=$suivant\"><img src='images/fleche.jpg' border=0 align='absmiddle'></a>&nbsp;&nbsp;&nbsp;";
		$tableau.="<a href=\"dessins.php?rep=$rep&image=$fin\"><img src='images/fleche.jpg' border=0 align='absmiddle'><img src='images/fleche.jpg' border=0 align='absmiddle'></a>";
		}
	$tableau.="</font></td></tr>\n";
	$tableau.="</table>";  
