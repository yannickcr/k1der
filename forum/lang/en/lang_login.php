...
'need_validation' => "Sorry, you have not validated your account yet.<br />Please check your email for the validation information before attempting to log in.<br /><strong><a href='index.php?act=reg&CODE=reval'>Resend the validation email</a></strong>",
...
wrong_name					=>	"Sorry, we could not find a member using those log in details.",
...
'form_invisible' => "Log in as invisible",
