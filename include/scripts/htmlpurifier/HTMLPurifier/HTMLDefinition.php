    ...
    function setup($config) {
        ...
        $allowed_tags =
            array(
                ...
                'colgroup', 'col', 'td', 'th', 'tr', 'object', 'param'
            );
        ...
        $e_block = "p | $e_heading | div | $e_lists | $e_blocktext | table | object";
        $e__flow = "#PCDATA | $e_block | $e_inline | $e_misc | param";
        ...
        $this->info['object']->child=
        $this->info['dd']->child  =
        $this->info['li']->child  =
        $this->info['div']->child = $e_Flow;
        
        $this->info['param']->child   = 
		...
		$this->info['object']->attr['type'] = $e_Text;
		$this->info['param']->attr['name'] = $e_Text;
		...
		$this->info['object']->attr['width'] =
		$this->info['object']->attr['height'] =
		...
		$this->info['object']->attr['data'] =
		$this->info['param']->attr['value'] =
