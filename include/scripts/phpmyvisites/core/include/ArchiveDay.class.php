	...
	function isArchived()
	{
		...
		{			
			...
			if(mysql_num_rows($r) > 0)
			{
				...
				if($delta < 0 )
				{
					print("There is currently an archiving which is being processed (idarchives = ".$l['idarchives']."). Please wait a few minutes (". -$delta ." seconds), and try again (we have to 	 the archive to be totaly computed!");
					exit;
				}
			}
		}
