...
$lang['auteur_email'] = "eros@msa.hinet.net"; // Translator's email
...
$lang['generique_lowpop'] = "<b>排除顯示較少人口數目部份的統計資料</b>";
$lang['generique_allpop'] = "<b>顯示包含所有人口數目的統計資料</b>";
...
$lang['visites_pagesvisiteurs'] = "平均每位訪客瀏覽的頁面數"; 
$lang['visites_pagesvisites'] = "每次參訪瀏覽的頁面數"; 
$lang['visites_pagesvisitessign'] = "平均每個有效參訪的瀏覽頁面數"; 
$lang['visites_tempsmoyen'] = "平均的參訪停留時間";
$lang['visites_tempsmoyenpv'] = "頁面的平均瀏覽時間";
$lang['visites_tauxvisite'] = "單頁參訪率"; 
$lang['visites_average_visits_per_day'] = "每日平均參訪率"; 
$lang['visites_recapperiode'] = "統計的摘要期間";
...
$lang['frequence_nouvellesvisites'] = "新到參訪次數";
$lang['frequence_visiteursconnus'] = "舊訪客";
$lang['frequence_nouveauxvisiteurs'] = "新訪客";
$lang['frequence_returningrate'] = "重返率";
$lang['pagesvues_vispervisgraph'] = "依到站參訪次數所作的訪客人數統計圖表";
$lang['frequence_vispervis'] = "依到站參訪次數所作的訪客人數統計";
...
$lang['pagesvues_help_pagename'] = "您知道您可以供給一個友善的名稱至您的網頁嗎？";
$lang['pagesvues_help_track_dls'] = "您知道您可以追蹤下載次數及外部的 Url 位址重新導向嗎？";
...
$lang['admin_url_generate_title'] = "<b>檔案下載 / Url 位址重新導向 : Url 位址產生器</b>";
$lang['admin_url_generate_intro'] = "phpMyVisites 能計數您的檔案下載次數，並且也可以追蹤外部的點擊至 URL 位址。下載次數及 URL 位址追蹤將出現在 phpMyVisites“頁面瀏覽”的節段中。 </p><p class='texte'> 為完成這個，您必須使用一個 URL 位址來指向其 phpmyvisites 檔案，然後它將被重新導向至您需要的 URL 位址。由於並非如此容易地來產生這樣一個 URL 位址，這裏提供一個工具可以使這個工作變得輕而易舉 (因為 phpMyVisites 對我們來說必須是一個簡單而又強有力的體驗)。簡單地填入表格中，點擊“Generate URL”(產生 URL) 鈕，然後您將可以非常容易地計數您的檔案下載次數或外部的 URL 位址重新導向！";
$lang['admin_url_generate_site_selection'] = "<b>選擇您想計數檔案下載次數或 URL 位址重新導向的站台</b>";
$lang['admin_url_generate_enter_url'] = "<b>輸入您的檔案之完整位址或者您想在統計資料中追蹤的外部 Url 位址：</b>";
$lang['admin_url_generate_help_enter_url'] = "說明：它必須類似於 '<b>http://www.yoursite.com/file/brilliant-software.zip</b>' 亦或是提供任何的 URL 位址重新導向，如 '<b>http://www.the-site-to-redirect.com</b>'";
$lang['admin_url_generate_friendly_name'] = "<b>友善的檔案或 URL 位址名稱顯示將被使用於頁面瀏覽表中：</b>"; 
$lang['admin_url_generate_help_friendly_name'] = "說明：您可以在 phpMyVisites 的頁面瀏覽節段中將“檔案或 Url 位址重新導向”作個分類以提供一個最佳的顯示。您可以以'<b>/</b>'符號來分隔其分類及其檔案或 Url 位址重新導向。舉例來說：其名稱可以像 '<b>my photos download/Summer in France</b>' 或 '<b>Partners/PHP.net website</b>' ：它將各別地分類在資料夾 '<b>my photos downloads</b>' 或在資料夾 '<b>Partners</b>' ：您將會在您的 phpMyVisites 介面的 '頁面瀏覽' 節段中看見它們在資料夾中。";
$lang['admin_url_generate_result_url'] = "<b>這兒是您可連結至的 URL 位址：</b>";
$lang['admin_url_generate_html_result'] = "<b>假如它對您來說是有用的，這兒是您可用的 HTML 連結：</b>";
$lang['admin_url_generate_image_legend'] = "<b>包含了 URL 位址重新導向及檔案下載追蹤的頁面瀏覽範例：</b>";
$lang['admin_site_link_javascript'] = "%s現在您必須把此追蹤器安裝於您的網頁上 (複製貼上此 Javascript 碼)。點這兒來顯示此 javascript 碼！%s";
$lang['admin_last_version'] = "<b>您是否已經擁有 phpMyVisites 最新版？ (極力推薦！)</b>";
...
$lang['pdf_summary_generate_link'] = "<b>產生一份 PDF 來呈現統計摘要</b><br/>(請先將語系切換至 English 再操作)";
...
$lang['install_mdpadmin'] = "<b>超級管理員密碼：</b><br/>(至少８碼且需包含數字）";
...
$lang['install_end_text'] = "<b>請確定您的 javascript 碼已被插入至您的網頁之中，然後就坐著等您的第一位訪客來囉！</b>";
...
$lang['install_send_mail'] = "<b>要每天接收一封包含每個站台統計資料摘要的郵件嗎？</b>";
...
// 10 Febuary week
$lang['tdate6'] = "%daynumeric% %monthshort% week";
