...
<p class="texte">{'contacts_thanks_dev'|translate:"Marc Boussard (XHTML/CSS, General), Xavier (Smarty, General), Christophe (PDF Generation), Jarda (bug fix & other features), All beta testers!"}</p>
