...
function google_spell($words){
	...
	$words = "<spellrequest textalreadyclipped=\"0\" ignoredups=\"0\" ignoredigits=\"1\" ignoreallcaps=\"1\"><text>" .$words. "</text></spellrequest>";
	...
	$path = "/tbproxy/spell?lang=fr&hl=fr";
	$host = "www.google.com";
...
// use XML Parser on $data, and your set!
	...
	*/
	...
	for ($i=1;$i<count($vals)-1;$i++) {
		return split ("\t", html_entity_decode($vals[$i]["value"]));
	}
