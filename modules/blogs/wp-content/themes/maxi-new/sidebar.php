	<div id="sidebar">
		<ul>
			<li id="search" class="widget widget_search">
				<form id="searchform" method="get" action="http://www.k1der.net/blog/maxi">
					<div>
						<input type="text" name="s" id="s" size="15" /><input type="image" src="<?php bloginfo('stylesheet_directory'); ?>/images/loupe.gif" alt="Recherche" />
					</div>
				</form>
			</li>
