...
$sub_template->setFile('centredroite','clans/admin/banniere.html');

/**
 * ACTION ENVOI FORMULAIRE
 */
if($this->action('changeBan','clans')) $clans->adminChangeBan($_GET['id'],$_POST['banniere'],$_POST['url'],$sub_template);
 ...
 */
$info=$sql->fetchAssoc($sql->query('SELECT nom,banniere FROM mod_membres_clans WHERE id="'.$_GET['id'].'"'));
