 ...
 */
$sub_template->setFile('centredroite','clans/edit.html');
$site->addToTitle(' - &Eacute;diter les infos du clan');

/**
 * Action envoi formulaire
 */
if($this->action('edit','clans')) $clans->edit($membres->infos('clan_id'),$_POST,$sub_template);
 ...
 */
$req=$sql->query('SELECT id,pseudo FROM mod_membres WHERE clan_id="'.$membres->infos('clan_id').'"');
