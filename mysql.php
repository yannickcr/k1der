...
?> 
<h3><font face="Verdana, Arial, Helvetica, sans-serif">Type</font></h3>
<font size="2" face="Verdana, Arial, Helvetica, sans-serif"> * `M' indicates the 
maximum display size.<br>
* `D' applies to floating-point types and indicates the number of digits following 
the decimal point.<br>
</font> 
<table>
  <tr> 
    <th><font face="Verdana, Arial, Helvetica, sans-serif">Type</font></th>
    <th><font face="Verdana, Arial, Helvetica, sans-serif">&nbspM&nbsp</font></th>
    <th><font face="Verdana, Arial, Helvetica, sans-serif">&nbspD&nbsp</font></th>
    <th><font face="Verdana, Arial, Helvetica, sans-serif">unsigned</font></th>
    <th><font face="Verdana, Arial, Helvetica, sans-serif">zerofill</font></th>
    <th><font face="Verdana, Arial, Helvetica, sans-serif">binary</font></th>
  </tr>
  <tr> 
    <td><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=radio name=type value="TINYINT" <? if( $type == "tinyint" ) echo "checked";?>>
      TINYINT (-128 ~ 127)</font></td>
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif">O</font></td>
    <td>&nbsp;</td>
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif">O</font></td>
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif">O</font></td>
    <td>&nbsp;</td>
  ...
  <tr> 
    <td><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=radio name=type value="SMALLINT" <? if( $type == "smallint" ) echo "checked";?>>
      SMALLINT (-32768 ~ 32767)</font></td>
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif">O</font></td>
    <td>&nbsp;</td>
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif">O</font></td>
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif">O</font></td>
  ...
  <tr> 
    <td><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=radio name=type value="MEDIUMINT" <? if( $type == "mediumint" ) echo "checked";?>>
      MEDIUMINT (-8388608 ~ 8388607)</font></td>
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif">O</font></td>
    <td>&nbsp;</td>
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif">O</font></td>
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif">O</font></td>
  ...
  <tr> 
    <td><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=radio name=type value="INT" <? if( $type == "int" ) echo "checked";?>>
      INT (-2147483648 ~ 2147483647)</font></td>
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif">O</font></td>
    <td>&nbsp;</td>
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif">O</font></td>
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif">O</font></td>
  ...
  <tr> 
    <td><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=radio name=type value="BIGINT" <? if( $type == "bigint" ) echo "checked";?>>
      BIGINT (-9223372036854775808 ~ 9223372036854775807)</font></td>
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif">O</font></td>
    <td>&nbsp;</td>
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif">O</font></td>
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif">O</font></td>
  ...
  <tr> 
    <td><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=radio name=type value="FLOAT" <? if( $type == "float" ) echo "checked";?>>
      FLOAT</font></td>
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif">O</font></td>
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif">O</font></td>
    <td>&nbsp;</td>
  ...
  <tr> 
    <td><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=radio name=type value="DOUBLE" <? if( $type == "double" ) echo "checked";?>>
      DOUBLE</font></td>
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif">O</font></td>
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif">O</font></td>
    <td>&nbsp;</td>
  ...
  <tr> 
    <td><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=radio name=type value="DECIMAL" <? if( $type == "decimal" ) echo "checked";?>>
      DECIMAL(NUMERIC)</font></td>
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif">O</font></td>
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif">O</font></td>
    <td>&nbsp;</td>
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif">O</font></td>
  ...
  <tr> 
    <td><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=radio name=type value="DATE" <? if( $type == "date" ) echo "checked";?>>
      DATE (1000-01-01 ~ 9999-12-31, YYYY-MM-DD)</font></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr> 
    <td><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=radio name=type value="DATETIME" <? if( $type == "datetime" ) echo "checked";?>>
      DATETIME (1000-01-01 00:00:00 ~ 9999-12-31 23:59:59, YYYY-MM-DD HH:MM:SS)</font></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr> 
    <td><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=radio name=type value="TIMESTAMP" <? if( $type == "timestamp" ) echo "checked";?>>
      TIMESTAMP (1970-01-01 00:00:00 ~ 2106..., YYYYMMDD[HH[MM[SS]]])</font></td>
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif">O</font></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr> 
    <td><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=radio name=type value="TIME" <? if( $type == "time" ) echo "checked";?>>
      TIME (-838:59:59 ~ 838:59:59, HH:MM:SS)</font></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr> 
    <td><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=radio name=type value="YEAR" <? if( $type == "year" ) echo "checked";?>>
      YEAR (1901 ~ 2155, 0000, YYYY)</font></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr> 
    <td><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=radio name=type value="CHAR" <? if( $type == "char" ) echo "checked";?>>
      CHAR</font></td>
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif">O</font></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr> 
    <td><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=radio name=type value="VARCHAR" <? if( $type == "varchar" ) echo "checked";?>>
      VARCHAR</font></td>
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif">O</font></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr> 
    <td><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=radio name=type value="TINYTEXT" <? if( $type == "tinytext" ) echo "checked";?>>
      TINYTEXT (0 ~ 255)</font></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr> 
    <td><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=radio name=type value="TEXT" <? if( $type == "text" ) echo "checked";?>>
      TEXT (0 ~ 65535)</font></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr> 
    <td><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=radio name=type value="MEDIUMTEXT" <? if( $type == "mediumtext" ) echo "checked";?>>
      MEDIUMTEXT (0 ~ 16777215)</font></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr> 
    <td><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=radio name=type value="LONGTEXT" <? if( $type == "longtext" ) echo "checked";?>>
      LONGTEXT (0 ~ 4294967295)</font></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr> 
    <td><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=radio name=type value="TINYBLOB" <? if( $type == "tinyblob" ) echo "checked";?>>
      TINYBLOB (0 ~ 255)</font></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr> 
    <td><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=radio name=type value="BLOB" <? if( $type == "blob" ) echo "checked";?>>
      BLOB (0 ~ 65535)</font></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr> 
    <td><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=radio name=type value="MEDIUMBLOB" <? if( $type == "mediumblob" ) echo "checked";?>>
      MEDIUMBLOB (0 ~ 16777215)</font></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr> 
    <td><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=radio name=type value="LONGBLOB" <? if( $type == "longblob" ) echo "checked";?>>
      LONGBLOB (0 ~ 4294967295)</font></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr> 
    <td><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=radio name=type value="ENUM" <? if( $type == "enum" ) echo "checked";?>>
      ENUM</font></td>
    <td colspan=5> 
      <center>
        <font face="Verdana, Arial, Helvetica, sans-serif">value list</font> 
      </center>
    </td>
  </tr>
  <tr> 
    <td><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=radio name=type value="SET" <? if( $type == "set" ) echo "checked";?>>
      SET</font></td>
    <td colspan=5> 
      <center>
        <font face="Verdana, Arial, Helvetica, sans-serif">value list</font> 
...
<table>
  <tr> 
    <th><font face="Verdana, Arial, Helvetica, sans-serif">M</font></th>
    <th><font face="Verdana, Arial, Helvetica, sans-serif">D</font></th>
    <th><font face="Verdana, Arial, Helvetica, sans-serif">unsigned</font></th>
    <th><font face="Verdana, Arial, Helvetica, sans-serif">zerofill</font></th>
    <th><font face="Verdana, Arial, Helvetica, sans-serif">binary</font></th>
    <th><font face="Verdana, Arial, Helvetica, sans-serif">value list (ex: 'apple', 
      'orange', 'banana') </font></th>
  </tr>
  <tr> 
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=text size=4 name=M <? if( $M != "" ) echo "value=$M";?>>
      </font></td>
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=text size=4 name=D <? if( $D != "" ) echo "value=$D";?>>
      </font></td>
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=checkbox name=unsigned value="UNSIGNED" <? if( strpos( $fieldtype, "unsigned" ) ) echo "checked";?>>
      </font></td>
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=checkbox name=zerofill value="ZEROFILL" <? if( strpos( $fieldtype, "zerofill" ) ) echo "checked";?>>
      </font></td>
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=checkbox name=binary value="BINARY" <? if( strpos( $fieldtype, "binary" )  ) echo "checked";?>>
      </font></td>
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=text size=60 name=valuelist <? if( $valuelist != "" ) echo "value=\"$valuelist\"";?>>
      </font></td>
  </tr>
</table>
<h3><font face="Verdana, Arial, Helvetica, sans-serif">Flags</font></h3>
<table>
  <tr> 
    <th><font face="Verdana, Arial, Helvetica, sans-serif">not null</font></th>
    <th><font face="Verdana, Arial, Helvetica, sans-serif">default value</font></th>
    <th><font face="Verdana, Arial, Helvetica, sans-serif">auto increment</font></th>
    <th><font face="Verdana, Arial, Helvetica, sans-serif">primary key</font></th>
  </tr>
  <tr> 
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=checkbox name=not_null value="NOT NULL" <? if( $fieldnull != "YES" ) echo "checked";?>>
      </font></td>
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=text name=default_value <? if( $fielddefault != "" ) echo "value=$fielddefault";?>>
      </font></td>
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=checkbox name=auto_increment value="AUTO_INCREMENT" <? if( $fieldextra == "auto_increment" ) echo "checked";?>>
      </font></td>
    <td align=center><font face="Verdana, Arial, Helvetica, sans-serif"> 
      <input type=checkbox name=primary_key value="PRIMARY KEY" <? if( $fieldkey == "PRI" ) echo "checked";?>>
      </font></td>
  </tr>
</table>
...
function viewData( $queryStr ) {
	...
	if( $queryStr == "" ) {
		...
		echo "<a href='$PHP_SELF?action=addData&dbname=$dbname&tablename=$tablename'><font color=#000000>Add Data</a> | \n";
		echo "<a href='$PHP_SELF?action=viewSchema&dbname=$dbname&tablename=$tablename'><font color=#000000>Schema</a>\n";
	}
	...
	for( $i = 0; $i < $col; $i++ ) {
		...
		echo "<th>";
		echo "<a href='$PHP_SELF?action=viewData&dbname=$dbname&tablename=$tablename&orderby=".$field->name."'><font color=#FFFFFF>".$field->name."</a>\n";
		echo "</th>\n";
	}
	echo "<th colspan=2>Action</th>\n";
	echo "</tr>\n";
	...
	for( $i = 0; $i < $rowperpage; $i++ ) {
		...
		if( $key == "" )
			...
			echo "<td><a href='$PHP_SELF?action=editData&dbname=$dbname&tablename=$tablename$key'><font color=#000000>Edit</a></td>\n";
			echo "<td><a href='$PHP_SELF?action=deleteData&dbname=$dbname&tablename=$tablename$key' onClick=\"return confirm('Delete Row?')\"><font color=#000000>Delete</a></td>\n";
		}
		echo "</tr>\n";
	}
	echo "</table>\n";
...
function manageData( $cmd ) {
	...
	echo "<input type=hidden name=dbname value=$dbname>\n";
	echo "<input type=hidden name=tablename value=$tablename>\n";
	echo "<td><font size=2 color=#DE0200>! Important !<font size=2 color=black> Pour aller à la ligne tape: &lt;br&gt; sinon ça marche pas<br>Et quand tu aura fini clique sur 'Edit Data' et supprime l'ancienne table<br><br><td><table cellspacing=1 cellpadding=2>\n";
	echo "<tr>\n";
	echo "<th>Name</th>\n";
	echo "<th>Type</th>\n";
	echo "<th>Function</th>\n";
...
function footer_html() {
	...
	echo "<a href='$PHP_SELF?action=listDBs'><font color=#000000>Database List</a> | \n";
	if( $tablename != "" )
		echo "<a href='$PHP_SELF?action=listTables&dbname=$dbname&tablename=$tablename'><font color=#000000>Table List</a> | ";
	echo "<a href='$PHP_SELF?action=utils'><font color=#000000>Utils</a> |\n";
	echo "<a href='$PHP_SELF?action=logout'><font color=#000000>Logout</a>\n";
	echo "</font>\n";
	echo "</body>\n";
	echo "</html>\n";
}
