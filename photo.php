...
if(!is_array($listing)) 
	...
	echo "photo.php?rep=totoimages</font>\n";
	}
else
	{
	...
	if($precedent!="")
		{
		$tableau.="<a href=\"photo.php?rep=$rep&image=$debut\"><img src='images/fleche2.jpg' border=0 align='absmiddle'><img src='images/fleche2.jpg' border=0 align='absmiddle'></a>&nbsp;&nbsp;&nbsp;\n";
		$tableau.="<a href=\"photo.php?rep=$rep&image=$precedent\"><img src='images/fleche2.jpg' border=0 align='absmiddle'></a>\n";
		}
	$tableau.="</font></td><td align=\"center\"><font face=\"Verdana\" size=\"2\">Photo <b>$numphoto</b> sur <b>$i</b></font></td>
	<td align=\"right\" width=\"10%\"><font face=\"Verdana\" size=\"2\">";
	// Liens suivant et fin
	if($suivant!="")
		{
		$tableau.="<a href=\"photo.php?rep=$rep&image=$suivant\"><img src='images/fleche.jpg' border=0 align='absmiddle'></a>&nbsp;&nbsp;&nbsp;";
		$tableau.="<a href=\"photo.php?rep=$rep&image=$fin\"><img src='images/fleche.jpg' border=0 align='absmiddle'><img src='images/fleche.jpg' border=0 align='absmiddle'></a>";
		}
	$tableau.="</font></td></tr>\n";
	$tableau.="</table>";  
