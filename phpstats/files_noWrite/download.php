...
$result=sql_query("SELECT name,value FROM $option[prefix]_config");//inserire modifiche per l'uso di options.php
//if(mysql_num_rows($result)!=43) die("<b>ERRORE</b>: Anomalia nella tabella $option[prefix]_config, dati di configurazione in numero non corretto (non 43).");
