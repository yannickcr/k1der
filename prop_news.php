...
EAWO(richTextFlag);
  ...
  <iframe name="XformFrame" style="position:absolute;visibility:hidden" WIDTH=0 HEIGHT=0></iframe>
        ...
        <form name="composeform" method="POST" action="prop_news2.php">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <TR class="forumline"> 
      ...
      <TD class=row2><SPAN class=genmed> <font size="2" face="Verdana, Arial, Helvetica, sans-serif"> 
		...
		$heure = date("H:i");
		?>
        <input name="auteur" type="text" id="auteur" value="">
      ...
      <TD class=row2><span class=genmed><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong>Date 
        :</strong> <? echo $date; ?> <strong>&amp;</strong> <strong>Heure :</strong> 
        <? echo $heure; ?> </font></span></TD>
    </TR>
    <TR class="forumline"> 
  ...
  <table align="center" cellpadding=0 cellspacing=0>
    <tr> 
          ...
          <textarea name="body" wrap="soft" style='visibility:visible; z-index:100; position:absolute; left:0px; top:0px; height=100%; width=100%'></textarea>
          <IFRAME SRC="admin/hot_news.php" id='richedit' style='visibility: hidden; position: absolute; left: 0px; top: 0px; height=100%; width=100%'></IFRAME>
        </div></td>
                </tr>
              </table>
